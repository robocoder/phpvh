...
namespace Components.Aphid.Tests.Integration
{
    ...
    public class ScopeTests : AphidTests
    {
        ...
        {
            AssertFalse("test=@(){x='foo'; ret x;}; test(); ret x?;");
        }

        [Test]
        public void ScopeTest2()
        {
            AssertFalse("test=@()x='foo'; test(); ret x?;");
        }

        [Test]
        public void ScopeTest3()
        {
            AssertTrue("x='foo'; ret x?;");
        }

        [Test]
        public void ScopeTest4()
        {
            AssertFalse("if (true) { x = 1; } ret x?;");
        }

        [Test]
        public void ScopeTest5()
        {
            AssertTrue("x = 0; if (true) { x = 1; } ret x?;");
        }
